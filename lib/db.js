  ...
  switch (method) {
    ...
    case 'create': case 'update':
      if (model.get('_rev')) {
        ...
        // TODO: this callback was causing data loss, disabled for now, and everything is good b/c we're relying on backbone to do the merging. Still… something is fishy here.
        // db.get(model.id, function(err, doc) {
          ...
          // }
          // else {
            db.save(model.id, toJSON(model), dbUpdateCb)
          // }
        // })
      }
      else {
